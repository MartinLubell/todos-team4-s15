...
nb.todolists.create! [{list_name: "Italian Campaign NB", list_due_date: "1796/11/01"},
                {list_name: "Russian Campaign NB", list_due_date: "1812/11/30"}]
...
nblistI = Todolist.find_by list_name: "Italian Campaign NB"
nblistR = Todolist.find_by list_name: "Russian Campaign NB"
